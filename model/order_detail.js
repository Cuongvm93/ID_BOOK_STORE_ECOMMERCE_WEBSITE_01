...
module.exports.getOrderDetail=(id,id_user)=>{
    return db.execute(`select name_product, b.id_order, b.quantity, b.price from tbl_product, (select id_product, id_order,  quantity, price from tbl_cart where id_order=${id} and id_user=${id_user}) as b where tbl_product.id=b.id_product`)
}
